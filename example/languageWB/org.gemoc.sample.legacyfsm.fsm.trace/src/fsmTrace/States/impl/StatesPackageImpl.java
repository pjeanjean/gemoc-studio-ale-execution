...
public class StatesPackageImpl extends EPackageImpl implements StatesPackage {
	...
	public void initializePackageContents() {
		...
		g2 = createEGenericType(theFsmPackage.getState());
		g1.getETypeArguments().add(g2);
		...
		initEReference(getStateMachine_currentState_Value_CurrentState(), theFsmPackage.getState(), null, "currentState", null, 0, 1, StateMachine_currentState_Value.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, !IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
